...
export const ProfileData = (props: PropsType) => {
    ...
    return (
        <div className={styles.root}>
                ...
                <li className={styles.item}>
                    <div className={styles.iconBlock}>
                        <img
                            ...
                            src={profileInfoIcons.lookingForAJob}
                ...
                {profile?.contacts && (
                    <li className={styles.contacts}>
                        <div className={styles.item}>
                            ...
                            <div>
                                Contacts:
                                {Object.values(profile.contacts).every((value) => !value) && <b> No contacts</b>}
                            </div>
                        </div>
                        <div>
            ...
            {isOwner && (
                <button className={styles.editButton} onClick={onActivateEditModeHandler}>
                    Edit
                </button>
            )}
        </div>
